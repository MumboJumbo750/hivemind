...
| `[DEAD LETTER]` | Outbox nach max Retries | Requeue, verwerfen |
...
Priorität 4: [SKILL PROPOSAL] + [GUARD PROPOSAL] (wartend auf Merge)
Priorität 5: [DEAD LETTER] (fehlgeschlagene Syncs)
Priorität 6: [UNROUTED] Events mit niedrigerer Severity
```
...
| | Triage | Architekt | Kartograph |
| --- | --- | --- | --- |
| Trigger | Externes Event / Proposal / Eskalation | Epic gescoppt | Neues Projekt / Follow-up |
| Fokus | Routing & Entscheidung | Planung & Zerlegung | Erkundung & Dokumentation |
| Rechte | Admin only | Epic-Owner / Admin | Kartograph-Rolle |
| Output | Event-Zuweisung, Merge-Entscheidung | Tasks, Boundaries | Wiki, Docs |
